public class MultipleCompnies {
    public static final int Is_Part_time = 1;
    public static final int Is_Full_time = 2;
    public static final int Employ_Rate_Per_hr = 20;
    public static final int Num_of_working_days = 2;
    public static final int MAX_HR_IN_MONTH= 10;
    public static int computeEmpWage(String Company_name, int employ_Rate_Per_hr,
                                     int Num_of_Working_Days, int Max_hr_per_month)
    {
        int employ_Hr = 0;
        int totalEmpHr = 0;
        int employ_wage = 0;
    ...
    public static void main(String[] args){
        computeEmpWage("Vijaya Sales" , 20,2,10);
        computeEmpWage("big bazar" , 25,3,19);
    }
